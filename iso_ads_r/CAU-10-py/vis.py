...
df_filtered = df[df['time_s']/3600 >= 1]
...
# fig,ax = plt.subplots()
# ax.plot(df_p['hpv'], df_p['uptake']/0.08, marker='o', label='CAU-10-py')
# ax.set_xlabel('humidity (%RH)')
# ax.set_ylabel('water uptake (wt.%)')
# ax.legend(loc='center right')
# plt.xlim(0,100)
# plt.ylim(0,600)
# plt.savefig('CAU-10-py adsorption isotherm of water_cm3g-1.png', dpi=1000)
# plt.show()